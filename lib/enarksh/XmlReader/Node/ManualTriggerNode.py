...
from lib.enarksh.XmlReader.Node.ActivateNode import ActivateNode


# ----------------------------------------------------------------------------------------------------------------------
class ManualTriggerNode(ActivateNode):
    # ------------------------------------------------------------------------------------------------------------------
    def _store_self(self, srv_id: int, uri_id: int, p_nod_master: int) -> None:
        ...
        """
        self._nod_id = DataLayer.enk_reader_node_store_manual_trigger(srv_id,
                                                                      uri_id,
